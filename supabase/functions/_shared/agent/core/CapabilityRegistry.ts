...
export const CAPABILITIES: readonly CapabilityEntry[] = [
  ...
  { key: "analysis.next_action", label: "Próximo passo", domain: "advisor", tool: "get_next_best_action", writes: false, risk: "read_only", surfaces: ["app", "whatsapp"], says: "dizer qual é o próximo passo mais importante para mudar comportamento e construir patrimônio" },
  { key: "advisor.change_commitment", label: "Assumir próximo passo", domain: "advisor", tool: "commit_latest_change_action", writes: true, risk: "low", surfaces: ["app", "whatsapp"], says: "acompanhar com você o próximo passo que foi combinado" },
  { key: "advisor.change_progress", label: "Acompanhar progresso", domain: "advisor", tool: "get_change_commitment_status", writes: false, risk: "read_only", surfaces: ["app", "whatsapp"], says: "mostrar se o combinado está avançando com base em fatos" },
  { key: "advisor.change_pause", label: "Pausar acompanhamento", domain: "advisor", tool: "pause_change_commitment", writes: true, risk: "low", surfaces: ["app", "whatsapp"], says: "parar de acompanhar um compromisso quando você pedir" },
