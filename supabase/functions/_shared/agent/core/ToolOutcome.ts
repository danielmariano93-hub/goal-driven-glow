...
const RULES: Rule[] = [
  ...
  { rx: /^(account_ambiguous|multiple_accounts)$/i, kind: "AMBIGUOUS", field: "account", ask: "Em qual conta eu registro?", optionsKey: "accounts" },
  ...
  { rx: /^account_not_found$/i, kind: "NEEDS_INPUT", field: "account", ask: "Em qual conta eu registro?", optionsKey: "accounts" },
