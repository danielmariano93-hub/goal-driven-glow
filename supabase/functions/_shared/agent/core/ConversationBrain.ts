...
19. domain é hierárquico: conversation para conversa sem dados pessoais; financial_read para leitura factual; financial_write para mutação; advisory para insight/orientação/estratégia financeira que precisa de dados pessoais. Domain NÃO escolhe ferramenta.
...
30. "Insight" pessoal nunca é conversation/direct_reply. "Qual insight para hoje?", "o que você percebe no meu mês?" ou "me dá uma leitura do mês atual" => mode=read, domain=advisory, advisory_kind=current_insight. Preserve em focus.period_expression a expressão temporal dita ("hoje", "mês atual", "este mês"). Não converta insight em next_best_action se o usuário não pediu ação.
