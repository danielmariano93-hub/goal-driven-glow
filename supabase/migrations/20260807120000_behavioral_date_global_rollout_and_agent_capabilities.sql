...
-- Análises de comportamento usam uma dimensão própria, auditável e reprocessável.
...
BEGIN
  -- iPhone/WhatsApp fornecem o instante mais forte. Madrugada até 04:00 pode
  -- pertencer à sessão iniciada na noite anterior; isso afeta comportamento,
  -- nunca a escrituração.
...
UPDATE public.user_communication_preferences SET
...
-- Executor do rascunho de rolê. Reutiliza split_create_v2: os mesmos checks,
-- arredondamento em centavos, participantes, lembretes e lançamento da UI.
