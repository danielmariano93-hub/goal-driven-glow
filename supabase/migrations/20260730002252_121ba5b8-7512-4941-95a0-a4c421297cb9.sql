CREATE TEMP TABLE _curated(kind text, channel text, title_template text, body_template text) ON COMMIT DROP;

INSERT INTO _curated(kind, channel, title_template, body_template)
