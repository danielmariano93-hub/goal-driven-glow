...
VALUES
  ('spending_trend','Evolução dos gastos',jsonb_build_object(
    'chart','line','curve','monotone','metric','behavioral_consumption',
    'series',jsonb_build_array('daily','cumulative_average'),
    'formula_version','financial_daily.v1'
  )),
  ...
  ('weekly_one_page','One Page semanal',jsonb_build_object(
    'sections',jsonb_build_array('snapshot','trend','categories','goals','next_actions'),
    'formula_version','financial_daily.v1'
  ))
