    ...
    <div className="space-y-6 pb-10">
      ...
      <section className="rounded-2xl border border-border bg-card p-4 shadow-card md:p-6">
        <div className="flex items-center gap-2">
          ...
          <div>
            <h2 className="text-sm font-semibold">Como o Nino personaliza suas análises</h2>
            <p className="text-xs text-muted-foreground">Estabelecimentos e preferências ficam aqui para você corrigir quando necessário.</p>
          </div>
        </div>
