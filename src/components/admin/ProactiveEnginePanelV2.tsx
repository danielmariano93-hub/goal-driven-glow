    ...
    <div className="space-y-6">
      ...
      <Section title="Simulação por usuário" icon={Play} description="Mostra o output que seria gerado. Não grava sugestão, notificação nem WhatsApp.">
        <div className="flex flex-col gap-2 md:flex-row">
          ...
          <button type="button" disabled={dryRun.isPending} onClick={() => dryRun.mutate()} className="inline-flex items-center justify-center gap-2 rounded-lg bg-primary px-4 py-2 text-sm text-primary-foreground disabled:opacity-60"><Eye size={15} /> {dryRun.isPending ? "Simulando..." : "Simular sem enviar"}</button>
        </div>
