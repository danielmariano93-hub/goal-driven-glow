...
import { behavioralMetricAmount, isRealMonthlyMovement, round2, effectiveCategoryId, buildRefundAttribution, type TransactionRow } from "./facts";
import { buildMerchantResolver, type MerchantAliasRow, type MerchantResolver } from "./merchant";
import { computeMerchantStats, type MerchantStats } from "./merchantIntelligence";
import {
