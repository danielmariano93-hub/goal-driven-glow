...
// ── Âncora de data única: America/Sao_Paulo (contrato P2-4) ──────────────────
// Nunca usar o timezone do browser para datas financeiras: fim de mês e
// meia-noite divergiriam entre App, Edge Functions e banco.
const SP_TZ = "America/Sao_Paulo";

/** Data de hoje em America/Sao_Paulo (YYYY-MM-DD). Fonte única no app. */
