...
import { round2, formatBRL, type TransactionRow } from "./facts";
import { classifyFlexibility, type SpendFlexibility } from "./costStructure";
import {
...
import type { EngineConfidence } from "./engineEnvelope";
